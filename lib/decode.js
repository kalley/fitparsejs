      ...
      if ( this.state === 'HEADER' ) {
          ...
          switch ( this.fileHeaderOffset++ ) {
            ...
            case 7:
              ...
              break;
            case 8:
              if ( strData !== '.' ) throw new Error("FIT decode error: File header signature mismatch.  File is not FIT.");
              break;
            case 9:
              if ( strData !== 'F' ) throw new Error("FIT decode error: File header signature mismatch.  File is not FIT.");
              break;
            case 10:
              if ( strData !== 'I' ) throw new Error("FIT decode error: File header signature mismatch.  File is not FIT.");
              break;
            case 11:
              if ( strData !== 'T' ) throw new Error("FIT decode error: File header signature mismatch.  File is not FIT.");
              break;
        }
